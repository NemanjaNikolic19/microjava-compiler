...
public class MultiArrayVarDecl extends VarDecl {

    private Type Type;
    private String firstName;
    private VarDeclTail VarDeclTail;

    public MultiArrayVarDecl (Type Type, String firstName, VarDeclTail VarDeclTail) {
        this.Type=Type;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MultiArrayVarDecl(\n");
