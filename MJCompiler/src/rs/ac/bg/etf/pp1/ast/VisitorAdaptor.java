...
public abstract class VisitorAdaptor implements Visitor { 
    ...
    public void visit(NeOp NeOp) { visit(); }
    public void visit(EqOp EqOp) { visit(); }
    public void visit(LeOp LeOp) { visit(); }
    public void visit(LtOp LtOp) { visit(); }
    public void visit(GeOp GeOp) { visit(); }
    ...
    public void visit(UnaryMinus UnaryMinus) { visit(); }
    ...
    public void visit(RelOperation RelOperation) { visit(); }
    public void visit(RelSingle RelSingle) { visit(); }
    public void visit(CondTernary CondTernary) { visit(); }
    public void visit(CondSingle CondSingle) { visit(); }
    public void visit(CondExprWrapper CondExprWrapper) { visit(); }
